...
//     ret = i2c_master_write_to_device(0, slv_address, write_buf, sizeof(write_buf), 1000 / portTICK_PERIOD_MS);
//     free(write_buf);
...
// {
//     return i2c_master_write_to_device(0, slv_address, data, sizeof(data), 1000 / portTICK_PERIOD_MS);
// }
